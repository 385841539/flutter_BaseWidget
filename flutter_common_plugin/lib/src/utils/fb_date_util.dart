...
class DateUtil {
  ...
  static String getTodayDayStr({String format = DataFormats.y_mo_d}) {
    return DateUtil.formatDateStr(getNowDateStr(),
        format: format ?? DataFormats.y_mo_d);
  }
  ...
  static getOffsetTime(int offsetTime) {
    return getDateTime(DateUtil.getDateStrByDateTime(

        ///往后两年
        DateUtil.getDateTimeByMs(DateUtil.getNowDateMs() + offsetTime),
        format: DateFormat.YEAR_MONTH_DAY));
  }

  static after({int year}) {}

  static before({int year}) {}
}
